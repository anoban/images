#pragma once
#define __INTERNAL
#if !defined(__HELPERS) && !defined(__INTERNAL) && !defined(__TEST__)
...
namespace endian {
    ...
    [[maybe_unused, nodiscard]] static unsigned long __stdcall ulong_from_be_bytes(_In_reads_bytes_(8) const unsigned char* const bytestream
    ) noexcept {
